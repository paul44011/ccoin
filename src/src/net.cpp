...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "clevelandcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetDNSSeed[][2] = {
    {"clevelandcointools.com", "192.210.138.243"},
    {"clevelandcoinpool.org", "192.210.138.243"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"clevelandcointools.com", "testnet-seed.clevelandcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. clevelandcoin is probably already running."), addrBind.ToString().c_str());
        else
